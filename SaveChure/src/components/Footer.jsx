...
const Footer = () => {
    ...
    <div className='Footer mt-10'>
          <div className='bg-[#9A1D20] min-w-full h-52'>
             ...
             <div className='Footer-txt flex justify-evenly'>
                ...
                <div>
  <h2 className="mb-4 text-[#ffffff]">Follow Us on Social Media</h2>
  <div className="flex justify-center md:justify-start space-x-4 ">
    ...
    <p className='text-center font-light p-8'>​Copyright © 2024 <span className='opacity-45 hover:opacity-80 cursor-pointer'>Freedom Studio.</span> All rights reserved.</p>
    </>
  )
}
